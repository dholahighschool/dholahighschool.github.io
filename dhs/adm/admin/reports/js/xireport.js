...
var rootRef = firebase.database().ref('xi2021/' + x).orderByChild(y);
...
function removeForm(id,x) {
  ...
  if (result.isConfirmed) {
    firebase.database().ref("xi2021/" + x + "/" + id).remove();
