...
var updcaste = getInputVal('updcaste');
 ...
 // Save message
  saveMessage(cat,name,dob,dobreg,gender,category,religion,mothertongue,nationality,aadhaar,bloodgroup,healthid,idmark,acyear,admno,admstatus,pvclass,pvaddl,prclass,pvroll,mpboard,pvschool,prroll,mpbengali,mpenglish,mpmath,mpphysc,mplfsc,mphist,mpgeo,mpaddl,mptotal,mpperrev,mpprc,prstream,prfcomp1,prfcomp2,prfsub1,prfsub2,prfsub3,prfsub4,medium,vill,habitation,district,block,panchayat,po,ps,pin,phone,email,fname,mname,gname,relationship,aincome,gqualification,gvill,ghabitation,gdistrict,gblock,gpanchayat,gpo,gps,gpin,gphone,gemail,bplstatus,bplno,cwsn,cwsntyp,bname,bcode,bifsc,acno,appid,updphoto,updsign,updmpadmit,updmpmark,updaadhaarpic,updbpass,updcaste);
